...
function FAQPage() {
    ...
    const faqs = [
        ...
        {
            question: "Do I need to log in to use GEO AI?",
            answer: "No, you do not need to log in to use GEO AI. You will still be able to run queries and view results without Google authentication. However, logging in allows you to see and edit your query history."
        },
        {
            question: "What is the mission of GEO AI?",
            answer: "GEO AI's mission is to support current geospatial AI development efforts in fields such as environmental protection, and make them more accessible to the public. With support from professors from the University of San Francisco Environmental Science Department, we aim to contribute to an exciting field of research and development that we believe can have a significant impact on the world."
        },
        {
            question: "Can I contribute to the GEO AI repository?",
            answer: "Yes, you can contribute to the GEO AI repository on GitHub. Currently, the best way to contribute is by submitting bug reports or feature requests via GitHub Issues. We welcome community contributions and feedback to help improve the platform."
        },
        {
            question: "I have more questions. Can I contact you for support?",
            answer: "You can reach out to us via email. The contact form is located on the Contact section of the footer. We are happy to assist with questions, feedback, or technical support related to GEO AI."
        }
    ];
